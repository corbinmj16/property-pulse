...
const FormPropertyEdit = ({ property }) => {
  const handleUpdateWithId = updateProperty.bind(null, property._id);

  return (
    <form action={handleUpdateWithId}>
...
export default FormPropertyEdit;
