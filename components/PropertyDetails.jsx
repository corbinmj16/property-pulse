      ...
      <div className="bg-white p-6 rounded-lg shadow-md text-center md:text-left">
        ...
        <div className="flex flex-col md:flex-row justify-around">
          <div className="flex items-center justify-center mb-4 border-b border-gray-200 md:border-b-0 pb-4 md:pb-0">
            <p className="text-gray-500 mr-2 font-bold">Nightly</p>
            <p className="text-2xl font-bold text-blue-500">
              {property.rates.nightly ? `$${property.rates.nightly.toLocaleString()}` : <FaTimes />}
            </p>
          </div>
          <div className="flex items-center justify-center mb-4 border-b border-gray-200 md:border-b-0 pb-4 md:pb-0">
            <p className="text-gray-500 mr-2 font-bold">Weekly</p>
            <p className="text-2xl font-bold text-blue-500">
              {property.rates.weekly ? `$${property.rates.weekly.toLocaleString()}` : <FaTimes />}
            </p>
          </div>
          <div className="flex items-center justify-center mb-4 pb-4 md:pb-0">
            <p className="text-gray-500 mr-2 font-bold">Monthly</p>
            <p className="text-2xl font-bold text-blue-500">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mt-6">
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 list-none">
          {property.amenities?.map((amenity, index) => (
            <li key={index}>
              <FaCheck className="inline-block text-green-600 mr-1" /> {amenity}
            </li>
          ))}
        </ul>
      </div>
...
export default PropretyDetails;
